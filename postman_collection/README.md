...
Файл `blog_network_api.postman_collection.json` содержит postman-коллекцию - набор заранее подготовленных запросов для проверки работы API.
...
Загрузите файл `blog_network_api.postman_collection.json` в Postman.
